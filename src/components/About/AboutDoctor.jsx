        ...
        <div className="container md:w-[83%] grid md:grid-cols-2 grid-row font-[Roboto] ">
          ...
          <div className="p-2">
            ...
            <p className=" text-xl opacity-75">
              ...
              years of experience in the field. Dr. Sinha is a specialist in
              urology, with a focus on minimally invasive surgery, endourology,
              pediatric urology, andrology, urolithiasis, laparoscopic urology,
              urethral stricture, urodynamics, prostate, prostate cancer,
              bladder cancer, and laparoscopic urology. At Kidney Stone &
              Urology Clinic, we are committed to providing the highest quality
              of care to our patients. We understand that urological conditions
              can be complex and sensitive, and we strive to provide a
              comfortable and supportive environment for our patients. Our team
              of highly trained and experienced medical professionals is
              dedicated to providing individualized care to each patient, and we
              work closely with our patients to develop personalized treatment
