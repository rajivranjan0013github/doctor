  ...
  return (
    <div className="fixed z-20 md:flex flex-col items-end justify-end	top-[30%] right-0 px-2 hidden">
      <Link target="_blank" to="https://wa.me/9709993104">
        <div
          className={` my-2 gap-2  rounded-full bg-green-500 text-white cursor-pointer flex justify-center  ${
            open === 0 ? "w-[150px]" : "w-8"
          }`}
      ...
      >
        <div
          className={`my-2 gap-2  rounded-full bg-blue-700 justify-center   text-white cursor-pointer flex  ${
            open === 1 ? "w-[150px]" : "w-8"
          }`}
      ...
      <div
        className={` gap-2  my-2 rounded-full bg-zinc-100 hover:bg-zinc-200  text-stone-700  cursor-pointer flex  ${
          open === 2 ? "w-[180px]" : "w-8"
        }`}
      ...
      <Link target="_blank" to="tel:9709993104">
        <div
          className={`my-2 gap-2  rounded-full bg-white hover:bg-zinc-200 text-blue-500 justify-center cursor-pointer flex ${
            open === 3 ? "w-[150px]" : "w-8"
          }`}
