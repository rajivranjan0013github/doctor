  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="text-zinc-700 py-8">{data.description}</h1>
      </div>
      <div>
        ...
        <h1 className="text-zinc-700 py-6">
          {data.indications &&
            Object.keys(data.indications).map((item) => (
              <li key={item}>{data.indications[item]}</li>
            ))}
        </h1>
      </div>
      <div>
        <h1 className="font-bold text-2xl ">{data.name} procedure</h1>
        <h1 className="text-zinc-700 py-6">{data.procedure}</h1>
      </div>
      ...
      <div>
        ...
        <h1 className="text-zinc-700 py-6">{data.recovery}</h1>
      </div>
      <div>
        <h1 className="font-bold text-2xl ">
          You or someone you know needed consultation?
        </h1>
        <h1 className="text-zinc-700 py-6">{data.consultation}</h1>
        <Link to="/appointment">
          <Button
