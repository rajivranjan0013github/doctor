...
const TreatmentDetailData=[
      ...
      },
  {
    ...
    recovery:
      'Recovery after Endourology depends on the specific procedure and the patient’s overall health. Generally, patients can return to normal activities relatively quickly. Post-operative care and follow-up appointments are essential for monitoring progress.',
    consultation:
...

{
  ...
  },
  {
    ...
    recovery:
      'Recovery after treatment for urethral strictures varies depending on the chosen procedure and the patient’s overall health. Patients may be advised to follow-up with their urologist for monitoring and to address any concerns.',
    consultation:
  ...
  recovery: 'Recovery after prostate cancer treatment varies depending on the chosen approach and the patient’s overall health. Follow-up care and monitoring are essential to track progress and manage any side effects or complications.',
  consultation:
...
},
{
    ...
    recovery:
      'Recovery after bladder cancer treatment depends on the chosen approach and the patient’s overall health. Follow-up care is essential to monitor progress, manage side effects, and prevent recurrence.',
    consultation:
  ...
  },
  {
    ...
    risksAndComplications:
      'While laser treatment in urology is generally safe, it can have risks such as bleeding, infection, or injury to surrounding structures. The specific risks may vary depending on the type of laser procedure and the patient’s individual health and condition.',
    recovery:
      'Recovery after laser treatment in urology depends on the specific procedure and the patient’s overall health. In many cases, patients can expect a quicker recovery compared to traditional surgical approaches. Follow-up care is essential to monitor progress and address any concerns.',
    consultation:
  ...
  },
  {
    ...
    benefits: [
      ...
      'Personalized treatment plans based on the patient’s specific condition.',
    ],
    risksAndComplications:
      'As with any surgical procedure, reconstructive urology surgeries can carry risks such as bleeding, infection, and complications related to anesthesia. The specific risks may vary depending on the type of procedure and the patient’s individual health and condition.',
    recovery:
...

  {
    ...
    recovery:
      'Recovery after laparoscopic surgery varies depending on the specific procedure and the patient’s overall health. Generally, patients can expect a quicker recovery compared to traditional open surgery. Post-operative care and follow-up appointments are essential for monitoring progress.',
    consultation:
...

  {
    ...
    },
    {
        ...
        recovery:
          'Recovery after Andrology procedures depends on the specific treatment and the patient’s overall health. Follow-up appointments are important for monitoring progress, managing any complications, or adjusting treatment plans.',
        consultation:
